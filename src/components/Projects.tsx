    ...
    <section id="projects" className="px-6 py-16 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          <div className="text-sm font-medium uppercase tracking-[0.22em] text-[#bf5700]">Selected Builds</div>
          <h2 className="mt-4 text-3xl font-semibold text-slate-900 sm:text-4xl">From Idea to MVP</h2>
